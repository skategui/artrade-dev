...
export const setAsAuthorizedDocument = (docId: string, context: Record<string, any>): void => {
...
})((context: AuthZContext & Record<string, any>, fieldArgs: unknown, doc: { _id?: string }) => {
  if (!doc) {
    return true;
  }
