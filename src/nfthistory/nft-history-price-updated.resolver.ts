...
import { NftPriceUpdatedHistoryRecord } from './model/nft-history-record.model';
import { NftHistoryService } from './nft-history.service';

@Resolver(() => NftPriceUpdatedHistoryRecord)
export class NftPriceUpdatedHistoryRecordResolver {
  constructor(
  ...
  @ResolveField(() => User)
  async owner(
    @Parent() record: NftPriceUpdatedHistoryRecord,
